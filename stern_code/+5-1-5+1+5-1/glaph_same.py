...
beta = 1.0
b = 0
OUTPUT_DIR = "../../../../imageデータ/Z_b_change報酬罰/+3+1-3-1+5+3"
INPUT_DIR = "../../../../imageグラフ/Z_b_change_罰入り/+3+1-3-1+5+3"

"""INPUT_FILE = f"Z={Z}_r={r}_alpha={alpha}_beta={beta}_NOomega.png"
ZIP_FILE = "../../../../imageデータ/Z_b_change報酬罰/+3+1-3-1+5+3/image_Z=95_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3.zip"
file_names = ['image_Z=95_b=0_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_vol2.csv','image_Z=95_b=0.2_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_vol2.csv','image_Z=95_b=0.4_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_vol2.csv','image_Z=95_b=0.6_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_vol2.csv',
              'image_Z=95_b=0.8_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_vol2.csv','image_Z=95_b=1.0_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_vol2.csv'] """


INPUT_FILE = f"b={b}_r={r}_alpha={alpha}_beta={beta}_omega.png"
ZIP_FILES = ["../../../../imageデータ/Z_b_change報酬罰/+3+1-3-1+5+3/image_Z=98_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.zip",
             "../../../../imageデータ/Z_b_change報酬罰/+3+1-3-1+5+3/image_Z=95_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.zip",
             "../../../../imageデータ/Z_b_change報酬罰/+3+1-3-1+5+3/image_Z=90_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.zip",
             "../../../../imageデータ/Z_b_change報酬罰/+3+1-3-1+5+3/image_Z=80_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.zip",
             "../../../../imageデータ/Z_b_change報酬罰/+3+1-3-1+5+3/image_Z=70_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.zip",
             "../../../../imageデータ/Z_b_change報酬罰/+3+1-3-1+5+3/image_Z=60_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.zip", 
             "../../../../imageデータ/Z_b_change報酬罰/+3+1-3-1+5+3/image_Z=50_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.zip",
            ]
FILE_NAMES = ['image_Z=98_b=0_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.csv',
              'image_Z=95_b=0_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.csv',
              'image_Z=90_b=0_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.csv',
              'image_Z=80_b=0_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.csv',
              'image_Z=70_b=0_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.csv',
              'image_Z=60_b=0_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.csv',
              'image_Z=50_b=0_r=3.0_α=0.1_β=1.0_+3+1-3-1+5+3_omega.csv',
              ] 

#OUTPUT_FILE = "image50000協力率_douki_Z=95.csv"
#INPUT_FILE = "shunning15000協力率_まとめ_1000間隔.png"

# ファイル名リスト
#file_names = ['shunning15000協力率変遷_traditional.csv','shunning15000協力率変遷_douki_Z=95.csv', 'shunning15000協力率変遷_douki_Z=95.csv', 'shunning15000協力率変遷_douki_Z=95.csv', 'shunning15000協力率変遷_douki_Z=95.csv']
