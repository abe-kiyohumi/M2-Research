...
def update_reputation(reputationgrid, grid, i, j, ni, nj):
    if grid[i, j] == 1:
        if reputationgrid[ni, nj] >= Z and reputationgrid[i, j] >= Z:
            ...
            reputationgrid[i, j] = reputationgrid[i, j] + 0.2
        elif reputationgrid[ni, nj] < Z and reputationgrid[i, j] < Z:
            reputationgrid[i, j] = reputationgrid[i, j] + 0.2
    elif grid[i, j] == -1:
        if reputationgrid[ni, nj] >= Z and reputationgrid[i, j] >= Z:
        ...
        if reputationgrid[ni, nj] >= Z and reputationgrid[i, j] >= Z:
            reputationgrid[i, j] = reputationgrid[i, j] + 1.6
        elif reputationgrid[ni, nj] >= Z and reputationgrid[i, j] < Z:
            reputationgrid[i, j] = reputationgrid[i, j] + 1.6
        elif reputationgrid[ni, nj] < Z and reputationgrid[i, j] >= Z:
            reputationgrid[i, j] = reputationgrid[i, j] + 0.6
        elif reputationgrid[ni, nj] < Z and reputationgrid[i, j] < Z:
            reputationgrid[i, j] = reputationgrid[i, j] + 0.6
    reputationgrid[i, j] = np.clip(reputationgrid[i, j], 0.0, 100.0)
    return reputationgrid
