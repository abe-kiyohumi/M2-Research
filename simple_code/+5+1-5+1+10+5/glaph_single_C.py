...
def file_select(Z):
    ...
    if Z == 50:
        print("Z=50を選択しました。")
        INPUT_FILE = f"{modelPATTERN}10000協力率_C_まとめ_Z=50_r=3.0_omega=0.1.png"
        ...
        print("Z=60を選択しました。")
        INPUT_FILE = f"{modelPATTERN}10000協力率_C_まとめ_Z=60_r=3.0_omega=0.1.png"
        ...
        print("Z=70を選択しました。")
        INPUT_FILE = f"{modelPATTERN}10000協力率_C_まとめ_Z=70_r=3.0_omega=0.1.png"
        ...
        print("Z=80を選択しました。")
        INPUT_FILE = f"{modelPATTERN}10000協力率_C_まとめ_Z=80_r=3.0_omega=0.1.png"
        ...
        print("Z=90を選択しました。")
        INPUT_FILE = f"{modelPATTERN}10000協力率_C_まとめ_Z=90_r=3.0_omega=0.1.png"
        ...
        print("Z=95を選択しました。")
        INPUT_FILE = f"{modelPATTERN}10000協力率_C_まとめ_Z=95_r=3.0_omega=0.1.png"
        ...
        print("Z=98を選択しました。")
        INPUT_FILE = f"{modelPATTERN}10000協力率_C_まとめ_Z=98_r=3.0_omega=0.1.png"
